...
//   // musiqalarni telefon xotirasidan o'qish uchun
...
//                       BoxShape.circle, const Offset(2.0, 2.0), 2.0, 0.0),
...
//     if (!kIsWeb) {
//       bool permisionStatus = await _audioQuery.permissionsStatus();
//       if (!permisionStatus) {
...
//     return BoxDecoration(color: Colors.amber, shape: shape, boxShadow: [
//       BoxShadow(
//           offset: -offset,
...
//     return BoxDecoration(borderRadius: borderRadius, boxShadow: [
//       BoxShadow(
//           offset: -offset,
//           color: Colors.white24,
//           blurRadius: blurRadius,
